...
# ---- pinned release ------------------------------------------------------
SCRIPT_URL="${KICKBACK_SCRIPT_URL:-https://raw.githubusercontent.com/gabeperez/kickback-cli/v0.1.1/kickback}"
SHA256_EXPECTED="44bfe5963ad9c0cc085e0ad55038f554abcc8ca0506e52077795f17d421ead7e"
# --------------------------------------------------------------------------
